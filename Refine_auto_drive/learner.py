...
from ding.worker.learner.learner_hook import build_learner_hook_by_cfg, add_learner_hook, merge_hooks, LearnerHook
...
class BaseLearner(object):
    ...
    def train(self, data: dict, envstep: int = -1, policy_kwargs: Optional[dict] = None) -> None:
        ...
        self.reward_model.collect_data(data)
        self.reward_model.train()
        data = self.reward_model.estimate(data)
