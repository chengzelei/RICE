...
# target agent path
parser.add_argument("--agent_path", type=str, default="/home/zck7060/Retrain_mujoco/hopper/baseline/tmp/best_model/best_model")
# masknet path
parser.add_argument("--masknet_path", type=str, default="/home/zck7060/Retrain_mujoco/hopper/masknet/models/best_model/best_model")
# tensorboard path
...
# training steps
parser.add_argument("--total_steps", type=int, default=1e4)
...
log_path = args.log_path + args.env + '/' + 'near_optimal' + '/' + args.bonus + '/' + 'bonus_scale_' + str(args.bonus) + '/' + 'p_' + str(args.go_prob) + '_seed' + str(args.seed) + '/'
tensorboard_path = args.tensorboard_path + args.env + '/' + 'near_optimal' + '/' + args.bonus + '/' + 'bonus_scale_' + str(args.bonus) + '/' + 'p_' + str(args.go_prob) + '_seed' + str(args.seed) + '/'
...
model = PPO.load(path=args.agent_path, tensorboard_log=args.tensorboard_path,\
                 custom_objects=custom_objects, env=env, bonus=args.bonus,\
