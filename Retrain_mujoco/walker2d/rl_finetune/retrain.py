...
env = VecNormalize.load("/home/zck7060/Retrain_mujoco/walker2d/baseline/weak_models/best_model/vec_normalize.pkl", env)
env.training = False
...
model = PPO.load("/home/zck7060/Retrain_mujoco/walker2d/baseline/weak_models/best_model/best_model", env=env, custom_objects=custom_objects, tensorboard_log="weak_tmp/")
