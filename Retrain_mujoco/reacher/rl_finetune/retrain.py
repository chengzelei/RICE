...
custom_objects = { 'learning_rate': 1e-5, 'n_steps': 16}
model =  PPO.load("/home/zck7060/Retrain_mujoco/reacher/baseline/weak_tmp/best_model/best_model", env = env, custom_objects=custom_objects, tensorboard_log="weak_tmp/")
