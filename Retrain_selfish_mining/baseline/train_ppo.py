...
def get_args():
    ...
    parser.add_argument('--logdir', type=str, default='baseline/ppo')
...
def test_ppo(args=get_args()):
    env = gym.make(args.task, random_sample=True)
    ...
    #     result = collector.collect(n_episode=200, render=args.render)
